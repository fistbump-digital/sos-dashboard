export const jobStatus = ["Open", "Draft", "Closed", "On hold"];
export const industries = ["Banking/ Financial Services/ Broking", "Insurance", "Other"];
export const companies = ['Max', "HDFC", "ICICI", "Reliance", "Bajaj", "Aviva", "Edelwiess", "Future Generali", "Other"];
export const verticals = ["Agency", "Bancassurance", "Direct", "F2F/ SPARC", "APC", "IMF", "Other"];
export const divisions = ["Axis", "Agencies", "Sparc", "Bancca", "APC", "Direct", "AP", "HDFC", "CSO", "Bajaj", "Yes", "Other"];
